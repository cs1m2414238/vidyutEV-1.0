...
const emptyProperty = {
  ...
  preferredPowerKw: 60, pricePerKwh: 16, photoUrls: '', ownershipDocumentUrl: '', discoverable: true,
};
    ...
    try {
      if (modal.kind === 'property') {
        await saveHostProperty(token, {
          ...
          ownershipDocumentUrl: form.ownershipDocumentUrl || form.photoUrls,
        }, modal.property?.id);
